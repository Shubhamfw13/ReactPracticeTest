...
const reqCityDataFail = (payload) => ({
  type: types.REQ_CITY_DATA_FAIL,
  payload,
});
...
const Get_Data = () => async (dispatch) => {
  ...
  axios
    .get("https://reactreduxtesteval.herokuapp.com/add-city")
    .then((res) => {
...
const AddCountry = (country) => async (dispatch) => {
  ...
  const res = await axios
    .post("https://reactreduxtesteval.herokuapp.com/add-country", {
      country,
    })
    .catch((err) => {
...
const AddCity = (city_name, population, country_name) => async (dispatch) => {
  ...
  const res = await axios
    .post("https://reactreduxtesteval.herokuapp.com/add-city", {
      city_name,
      population,
      country_name,
    })
